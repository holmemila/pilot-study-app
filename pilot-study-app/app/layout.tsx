...
export const metadata: Metadata = {
  title: "SquawkPPL | Free EASA PPL Theory Study",
  ...
  openGraph: {
    title: "Squawk | Free EASA PPL Theory Study",
  ...
  return (
    <html lang="en">
      <head>
        <Script
          async
          src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-9863520820448448"
